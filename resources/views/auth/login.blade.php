              ...
              <form class="pt-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="email" class="form-control form-control-lg border-left-0" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
